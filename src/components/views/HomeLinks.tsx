...
import { Home, EmoticonCoolOutline, SourceRepositoryMultiple } from 'mdi-material-ui'
...
export default () => {
  const data = [
    ...
    { title: 'MirrorZ Homepage', href: 'https://mirrorz.org', icon: <SourceRepositoryMultiple /> }
  ]
