    ...
    <Container maxWidth="lg">
      <Grid container alignItems="flex" spacing={4}>
        <Grid item xs={12} md={4}>
          <Card elevation={3}>
            <CardMedia component="img" eight="140" image="https://sist.shanghaitech.edu.cn/_upload/article/images/9b/f6/88d02686447ea6265581235d1c51/84f80642-009c-41c3-903f-7449ac09a5ab.jpg"/>
            <CardContent>
